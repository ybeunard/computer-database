...
public class TestEntrepriseDao extends TestCase {
    ...
    public void testEntrepriseDao() throws ConnexionDatabaseException, RequeteQueryException {

        Optional<List<Optional<Entreprise>>> entreprises = this.dao.findEntreprise();
