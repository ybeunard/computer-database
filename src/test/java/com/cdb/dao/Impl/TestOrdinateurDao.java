...
public class TestOrdinateurDao extends TestCase {
    ...
    private IDataSet readDataSet1() throws Exception {
        ...
        return new FlatXmlDataSetBuilder().build(new File("src/test/resources/dataTestOrdinateurDao.xml"));
    ...
    @Test
    public void testFindOrdinateur() throws ConnexionDatabaseException, RequeteQueryException {
